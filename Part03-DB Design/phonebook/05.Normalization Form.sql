...
CREATE TABLE PhoneBookV5_1_(
	...
	HomePhone char(11),
	PhoneType nvarchar(20),--Cho gõ loại phone, gây lộn xộn loại phone, cell, di động, dđ, moblie
						 --Thống kê khó khăn, OR, VÀ CÒN TIẾP TỤC OR NỮA DO GÕ TỰ DO
...
INSERT INTO PersonV5_1 VALUES (N'hoang nt', 'Lecturer', 'FPTU HCMC')
...
--Table mới xuất hiện, lưu những loại số phone o cho gõ lung tung~~~ Table Province, City, Country, Semester
...
INSERT INTO PhoneBookV5_1 VALUES ('098x', N'Cha dượng ngọt ngào', N'hoang nt')
--AN có 2 số phone làm sao để lưu??
...
INSERT INTO PhoneBookV5_1 VALUES ( '090x ', N'Di động', N'binhle')
INSERT INTO PhoneBookV5_1 VALUES ('091x ', N'Cha dượng ngọt ngào', N'binhle')
...
(
	Nick nvarchar(30) PRIMARY KEY,--còn cần bàn thêm về key here/performance
	--.....CompanyName....
	Title nvarchar(30),
	Company nvarchar(40)
	)
...
CREATE TABLE PhoneBookV5(
	...
	TypeName nvarchar(20) REFERENCES PhoneTypeV5(TypeName), --nó thuộc loại mẹ j
	Nick nvarchar(30) REFERENCES PersonV5(Nick), --của thg ku nào
	--loại j và của ai không gõ lung tung
	CONSTRAINT PK_PHONEBOOKV5 primary key(Phone)
)
--Table mới xuất hiện, lưu những loại số phone o cho gõ lung tung~~~ Table Province, City, Country, Semester
CREATE TABLE PhoneTypeV5
(
	TypeName nvarchar (20) NOT NULL--còn cần bàn thêm về key here/performance
